...
public class JwtUtil {
    ...
    public static String sign(String uname, String uid) {
        //过期时间
        ...
        return JWT.create().withHeader(header).withClaim(TOKEN_LOGIN_NAME, uname).withClaim(TOKEN_LOGIN_ID, uid).withExpiresAt(date).sign(algorithm);
    }
